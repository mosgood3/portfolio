...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  return (
    <div
      ref={wrapRef}
      className={`relative w-full h-[400px] sm:h-[450px] lg:h-[500px] ${className}`.trim()}
      style={{
        ...cardStyle,
        perspective: '1000px',
        maxWidth: '384px',
    ...
    >
      ...
      >
        ...
        <div 
          ...
          style={{
            background: `radial-gradient(600px circle at var(--pointer-x) var(--pointer-y), rgba(255,255,255,0.4), transparent 40%)`,
          }}
        />
        ...
        <div 
          ...
          style={{
            background: `radial-gradient(300px circle at var(--pointer-x) var(--pointer-y), rgba(255,255,255,0.2), transparent 60%)`,
          }}
        />
